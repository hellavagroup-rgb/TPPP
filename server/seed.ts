  ...
  formTemplates: [
    {
      ...
      fields: [
        { id: "intro", type: "info", label: "Introduction", content: "This form enables us to plan next steps and to ensure that we are the best fit for you." },
        { id: "dob", type: "date", label: "Date of Birth", required: true },
        { id: "phone", type: "tel", label: "Telephone number", required: true },
        { id: "reason", type: "textarea", label: "What has led you to seek support at this time?", required: true }
      ]
    }
  ]
};
